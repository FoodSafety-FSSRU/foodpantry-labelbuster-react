        ...
        <>
          ...
          <figure>
            ...
            //@todo might need to resize image to be smaller and more suitable for an accordiion panel.
              src="public\about-food-labels-page-7ingredients.png"
      ...
      content: (
        <>
          ...
          <figure>
            <img
            //@todo might need to resize image to be smaller and more suitable for an accordiion panel.
              src="public\about-food-labels-page-8advisorystatements.png"
              alt="Example food label with a list of ingredients."
              className="img-fluid"
            />
          </figure>
      ...
      content: (
        <>
          ...
          <figure>
            <img
            //@todo might need to resize image to be smaller and more suitable for an accordiion panel.
              src="public\exampleNIPformat.png"
      ...
      <div>
        ...
        <figure className="">
          ...
          <img
            ...
            src="public\About food main image.png"
